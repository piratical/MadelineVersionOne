...
#define MERLIN_ALLELE_WIDTH 3

void MerlinQTDTDataHeaderProcessor(PCONTROL,char *fn);
void MerlinQTDTOutputPedigree(PCONTROL,PPEDIGREE);
void MerlinQTDTDataFooterProcessor(PCONTROL);
