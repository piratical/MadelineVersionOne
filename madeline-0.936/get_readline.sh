...
# |_______________________________________________________________________________|
#                                                                                  
# "get_readline.sh" is part of the Madeline software distribution.                 
...
#                                                                                  
# Last modified by Ed Trager, November 2001.                                       
#                                                                                  
# *********************************************************************************
#
# get_readline.sh: script to retrieve and install the GNU readline v. 4.1
# library used by Madeline from our eyegene web site.  You could of course
# also get this library from the horse's mouth at ftp://ftp.gnu.org ...
#
# -- 2001.11.29 -- Edward Trager
#
PWD=`pwd`
if test "X$PREFIX" = "X"
then echo "********************************************************************"
     echo "**** Script needs to be called with \$PREFIX set to specify the  ****"
     echo "**** installation prefix for the GNU readline v. 4.1 library    ****"
     echo "****                                                            ****"
     echo "**** i.e.: \"PREFIX=/home/cat ./get_readline.sh\"                 ****" 
     echo "********************************************************************" 
     exit 1
else
     if test $PREFIX = "NONE"
...
then ANSWER=z
     ...
     do echo "********************************************************************"
        echo "****                 ** get_readline.sh **                      ****"
        echo "****                 ---------------------                      ****"
        echo "****                                                            ****"
        echo "**** Assuming that you have the necessary permissions,          ****"
        echo "**** this script can download and install the GNU readline      ****"
        echo "**** and history libraries in \"$PREFIX\""
     ...
     echo "********************************************************************"
     echo "**** Starting attempt to download readline library ...          ****"
     echo "********************************************************************"
     cd .. && wget http://eyegene.ophthy.med.umich.edu/downloads/readline-4.1.tar.gz
     if test $? -eq 0
     then echo "***************************************************************"
     ...
     echo "********************************************************************" 
     gzip -cd readline-4.1.tar.gz | tar xvf -
     if test $? -eq 0
     then echo "***************************************************************"
     ...
     cd readline-4.1 && ./configure --prefix=$PREFIX
     if test $? -eq 0
     then echo "***************************************************************"
          echo "**** Configuration of GNU readline looks OK ...            ****"
     ...
     if test $? -eq 0
     then echo "***************************************************************"
          echo "**** Make successfully completed compiling GNU readline.   ****"
     ...
     if test $? -eq 0
     then echo "**********************************************************************" 
          echo "**** GNU Readline v. 4.1 downloaded and installed successfully !! ****"
          echo "****                                                              ****"
          ...
          echo "******************************************************************************"
          echo "**** Sorry, script did not complete installation of GNU readline !        ****"
